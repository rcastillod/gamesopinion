<template>
    <div>
        ...
        <form 
            ...
            <div class="buttons-wrapper" style="justify-content: center;">
                <b-button class="mt-3 btn-game" block @click="goBack">Regresar</b-button>
                <b-button class="mt-3 btn-game btn-game__accent" block @click="editOpinion(opinionId)">Guardar</b-button>
            </div>
        </form>
    </div>
</template>
